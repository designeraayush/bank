...
<div class="container container-fluid">
	<div class="panel panel-default panel-info">
        ...
        <h2>Enter Withdraw Information</h2>
        </div>
        <div class="panel-body">
         <?php
			...
			{
				?>
                <div class="navbar alert alert-success">Amount Withdrawn Successfully..</div>
                <?php
			}
		  ?>
        ...
        <div class="form-control-static container-fluid">
        	<form action="withdrawreg.php" method="post" enctype="multipart/form-data">
